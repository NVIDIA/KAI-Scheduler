...
// +kubebuilder:rbac:groups=run.ai,resources=pods,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=run.ai,resources=pods/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=run.ai,resources=pods/finalizers,verbs=create;patch;update
