...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ActionConfigs) DeepCopyInto(out *ActionConfigs) {
	{
		in := &in
		*out = make(ActionConfigs, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionConfigs.
func (in ActionConfigs) DeepCopy() ActionConfigs {
	if in == nil {
		return nil
	}
	out := new(ActionConfigs)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in PluginConfigs) DeepCopyInto(out *PluginConfigs) {
	{
		in := &in
		*out = make(PluginConfigs, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginConfigs.
func (in PluginConfigs) DeepCopy() PluginConfigs {
	if in == nil {
		return nil
	}
