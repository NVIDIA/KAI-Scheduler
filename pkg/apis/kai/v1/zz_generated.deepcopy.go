...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScenarioSearchCheckpoints) DeepCopyInto(out *ScenarioSearchCheckpoints) {
	*out = *in
	if in.MaxJobs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScenarioSearchCheckpoints.
func (in *ScenarioSearchCheckpoints) DeepCopy() *ScenarioSearchCheckpoints {
	if in == nil {
		return nil
	}
	out := new(ScenarioSearchCheckpoints)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SchedulingShardSpec) DeepCopyInto(out *SchedulingShardSpec) {
	*out = *in
	...
	if in.ScenarioSearchCheckpoints != nil {
		in, out := &in.ScenarioSearchCheckpoints, &out.ScenarioSearchCheckpoints
		*out = new(ScenarioSearchCheckpoints)
		(*in).DeepCopyInto(*out)
	}
	if in.Plugins != nil {
