...
import (
	...
	kaiv1 "github.com/NVIDIA/KAI-scheduler/pkg/apis/client/listers/kai/v1"
	apiskaiv1 "github.com/NVIDIA/KAI-scheduler/pkg/apis/kai/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KaiV1().Topologies().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KaiV1().Topologies().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KaiV1().Topologies().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KaiV1().Topologies().Watch(ctx, options)
			},
		},
		&apiskaiv1.Topology{},
		resyncPeriod,
...
func (f *topologyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskaiv1.Topology{}, f.defaultInformer)
}

func (f *topologyInformer) Lister() kaiv1.TopologyLister {
	return kaiv1.NewTopologyLister(f.Informer().GetIndexer())
}
