...
// ListRuntimeClasses mocks base method.
func (m *MockDataLister) ListRuntimeClasses() ([]*v10.RuntimeClass, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListRuntimeClasses")
	ret0, _ := ret[0].([]*v10.RuntimeClass)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListRuntimeClasses indicates an expected call of ListRuntimeClasses.
func (mr *MockDataListerMockRecorder) ListRuntimeClasses() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListRuntimeClasses", reflect.TypeOf((*MockDataLister)(nil).ListRuntimeClasses))
}
