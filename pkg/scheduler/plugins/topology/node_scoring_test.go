...
func TestGetNodeSetID(t *testing.T) {
	tests := []struct {
		name          string
	...
	}{
		{
			name:          "empty node set",
			nodeSet:       node_info.NodeSet{},
			shouldBeEmpty: false, // empty set still generates a hash
		},
		{
			name: "single node",
			nodeSet: node_info.NodeSet{
				{Name: "node1", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node1"}}},
			},
			shouldBeEmpty: false,
		},
		{
			name: "multiple nodes - order doesn't matter",
			nodeSet: node_info.NodeSet{
				{Name: "node2", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node2"}}},
				{Name: "node1", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node1"}}},
				{Name: "node3", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node3"}}},
			},
			shouldBeEmpty: false,
		},
	}
...
func TestGetNodeSetID_Consistency(t *testing.T) {
	// Test that same nodes in different order produce the same ID
	nodeSet1 := node_info.NodeSet{
		{Name: "node1", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node1"}}},
		{Name: "node2", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node2"}}},
		{Name: "node3", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node3"}}},
	}

	nodeSet2 := node_info.NodeSet{
		{Name: "node3", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node3"}}},
		{Name: "node1", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node1"}}},
		{Name: "node2", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node2"}}},
	}

	id1 := getNodeSetID(nodeSet1)
	id2 := getNodeSetID(nodeSet2)

	assert.Equal(t, id1, id2, "Node sets with same nodes in different order should produce same ID")
}

func TestGetNodeSetID_Uniqueness(t *testing.T) {
	// Test that different node sets produce different IDs
	nodeSet1 := node_info.NodeSet{
		{Name: "node1", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node1"}}},
		{Name: "node2", Node: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "node2"}}},
	}
	...
	assert.NotEqual(t, id1, id2, "Different node sets should produce different IDs")
}
