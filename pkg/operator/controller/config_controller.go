...
// +kubebuilder:rbac:groups="",resources=services;secrets;serviceaccounts;configmaps;persistentvolumeclaims;pods,verbs=get;list;watch;create;update;patch;delete
