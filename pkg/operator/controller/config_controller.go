...
// +kubebuilder:rbac:groups="",resources=services;secrets;serviceaccounts;configmaps;persistentvolumeclaims;nodes;nodes/proxy;endpoints;pods,verbs=get;list;watch;create;update;patch;delete
