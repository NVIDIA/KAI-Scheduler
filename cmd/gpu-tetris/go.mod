module github.com/NVIDIA/KAI-scheduler/cmd/gpu-tetris

go 1.24.4

replace github.com/NVIDIA/KAI-scheduler => ../..

require (
	github.com/NVIDIA/KAI-scheduler v0.0.0-00010101000000-000000000000
	k8s.io/api v0.34.2
